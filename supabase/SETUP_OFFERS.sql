-- Setup: Add offers and payments tables
-- Run this in your Supabase SQL Editor to enable Offers functionality
...
DROP POLICY IF EXISTS "Users can view payments for their offers" ON payments;
DROP POLICY IF EXISTS "Users can insert payments for their offers" ON payments;
DROP POLICY IF EXISTS "Users can update payments for their offers" ON payments;
